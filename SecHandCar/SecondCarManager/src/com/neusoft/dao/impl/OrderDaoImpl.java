...
public class OrderDaoImpl extends BaseDaoImpl<Order> implements OrderDao{
	...
	@Override
	public Pager<Order> findPager1(Order order) {
		if(order.getCode() !=null && !"".equals(order.getCode() )){
	    	   String hql = "from Order where code like :code and state =1 order by id desc";
	    	   Map<String,Object> alias = new HashMap<String,Object>();
	   		   alias.put("code", "%" +order.getCode()+ "%" );
	   		  return findByAlias(hql, alias);
	       }else{
	    	   String hql = "from Order where 1=1  and state =1  order by id desc";
				return findByAlias(hql, null);
	       }
	}
