...
<body>
<form action="carCategory_exUpdate.do" method="post" class="definewidth m20" id="hh">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="10%" class="tableleft">汽车分类名称</td>
        <td><input type="text" name="cname" id="cname" value="${carCategory.cname}"/>
         <input type="hidden" name="id" value="${carCategory.id}">
        </td>
    </tr>
     <tr>
        <td width="10%" class="tableleft">库存数量</td>
        <td><input type="text" name="number" id="number" value="${carCategory.number}"/></td>
    </tr>
    <tr>
