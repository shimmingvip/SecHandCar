...
<table class="table table-bordered table-hover definewidth m10">
    <tr>
     ...
     <tr>
        <td width="10%" class="tableleft">车名</td>
        <td><input type="text" name="carName" id="carName" value="${car.carName}"/></td>
    </tr>
     <tr>
        <td width="10%" class="tableleft">油耗</td>
        <td><input type="text" name="carOilConsumption" id="carOilConsumption" value="${car.carOilConsumption}"/>
